...
![Alt text for the image](frag.png)
```{r}
...
## Ex2- Compare the distribution of raw identification scores of the decoy and non-decoy hits. Interpret the figure.

# it is not a good separation between these two dataset in this example.
